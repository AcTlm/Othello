...
from player_class_with_AlphaBeta import Joueur
import time
import csv
import tracemalloc
import gc
...
for i in range(20):
    ...
    try:
        ...
        pass
    with open(f"{description_joueur_1}_vs_{description_joueur_2}_{nombre_repetitions}_repetitions_{i}.csv",'w',newline="") as f:
