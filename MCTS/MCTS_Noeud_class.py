...
class MCTS_Noeud:
    ...
    def __init__(self, plat, parent=None, coup=[], Joueur_=Joueur_, Autre_Joueur=Autre_Joueur):
        self.plat=plat
        self.parent=parent
        self.coup=coup
    ...
    def ajout_enfant_aleatoire(self, Joueur_, Autre_Joueur):
        ...
        print(self.plat)
        nouveau_noeud=MCTS_Noeud(self.plat, self, nouveau_coup, Autre_Joueur, Joueur_)
