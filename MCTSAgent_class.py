...
# fonction calculant score uct pour un noeud: tient compte de la performance associée à ce noeud(% victoires d'un joueur) et du facteur d'exploration (ici C est racine de 2)
